      ...
      <div class="row">
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open_multipart('jawaban/tambahJawaban', array('class'=>'form-horizontal')); ?>
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Nilai</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nilai_jwb" name="nilai_jwb" placeholder="Nilai">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea class="form-control" id="desk_jwb" name="desk_jwb" placeholder="Deskripsi"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="point_jwb" name="point_jwb" placeholder="Point">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="file" class="form-control" name="icon_url" id="">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
